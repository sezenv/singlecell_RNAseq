...
# Step04: clustering and pseudotime calculating

# Here's the modified and updated script to reproduce the scRNA analysis
# The detailed instructions are on the Youtube video: https://www.youtube.com/watch?v=IjJOTJsd4Mg

## Some prep
# download the input data files as "GSE111429_RAW.tar" from https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE111429
...
PG_all <- PercentageFeatureSet(PG_all, pattern = "^mt-", col.name = "percent.mt")## if human, "^MT-"
